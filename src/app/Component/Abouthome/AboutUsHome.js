...
function AboutUsHome() {
    return (
        <Container>
            <Stack sx={{ flexDirection: { md: 'row', xs: 'column' }, padding: { md: '30px 0px', xs: '30px 0' }, gap: { xs: 3, md: 7 }, color: 'rgb(15 43 86)', justifyContent: 'space-between' }}>
                ...
                <Stack sx={{ width: { lg: '60%', md: '50%' }, padding: '10px 0' }}>
                    ...
                    <Stack sx={{ alignItems: 'center', flexDirection: 'row', gap: 2 }}>
                        <hr style={{ width: '40px', display: 'inline-block', opacity: '1', borderTop: '2px solid #B31319' }} />
                        <Typography sx={{ color: '#B31319', fontWeight: '600', fontSize: '25px', padding: '10px 0' }}>
                            Comprehensive Energy Metering Solutions
                    </Typography>
                    </Stack>
